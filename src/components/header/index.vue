  ...
  <div class="header-music-search">
    ...
    <!--
      ...
      <div class="search-history">
        <div class="search-history-item" v-for="(item, index) in searchHistory" :key="index" @click="search(item)">{{item}}</div>
      </div>
      <ul>
    ...
    <div class="result" v-if="searchRes!=null&&searchShow">
      ...
      <div class="result-group" v-if="searchRes.mv!=null">
        ...
        <div class="mv-item" @click="openmv(item.vid)" v-for="(item, index) in searchRes.mv.itemlist" :key="index">
